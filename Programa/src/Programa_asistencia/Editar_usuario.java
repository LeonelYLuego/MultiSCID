...
public class Editar_usuario extends javax.swing.JDialog {
    ...
    void mostrarDatos(String valor) {
        ...
        String Consult;
        if(valor.equals("")){
            Consult = "SELECT ID_usuario, Nombre_usuario, Contraseña, Puesto FROM usuarios";
        }
        else{
            Consult = "SELECT ID_usuario, Nombre_usuario, Contraseña, Puesto FROM usuarios WHERE (Nombre_usuario='" + valor + "');";
        }
