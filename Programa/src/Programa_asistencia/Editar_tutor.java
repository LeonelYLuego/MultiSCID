...
public class Editar_tutor extends javax.swing.JDialog {
    
    private PreparedStatement PS;
    private Conector CN;
    DefaultTableModel modelo = new DefaultTableModel();

    public Editar_tutor(java.awt.Frame parent, boolean modal, boolean visualizar) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 1220, 400));
        ...
        jPanel1.add(btnEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 30, 90, -1));
        ...
        jPanel1.add(btnRegresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1140, 480, -1, -1));
        ...
        jPanel1.add(txtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 260, -1));
        ...
        jPanel1.add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 30, 100, -1));
        ...
        jPanel1.add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 30, 90, -1));
        ...
        jPanel1.add(btnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1140, 30, 90, -1));

        jLabel1.setFont(new java.awt.Font("Berlin Sans FB", 0, 14)); // NOI18N
        jLabel1.setText("Nombre, apellido paterno o CURP:");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, -1));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1250, 520));
    ...
    void mostrarDatos(String valor) {
        ...
        String Consult;
        if(valor.equals("")){
            Consult = "SELECT t.CURP_tutor, t.Nombre, t.Apellido_paterno, t.Apellido_materno, t.Correo_electronico, d.Estado, d.Municipio, d.Colonia, d.Calle, d.Num_ext, d.Num_int, d.Codigo_postal, f.LADA, f.Numero_tel, f.Tipo FROM tutores t, direccion_vivienda d, telefonos f WHERE t.CURP_tutor = d.CURP_tutor AND t.CURP_tutor= f.CURP_tutor";
        }
        else{
            Consult = "SELECT t.CURP_tutor, t.Nombre, t.Apellido_paterno, t.Apellido_materno, t.Correo_electronico, d.Estado, d.Municipio, d.Colonia, d.Calle, d.Num_ext, d.Num_int, d.Codigo_postal, f.LADA, f.Numero_tel, f.Tipo FROM tutores t, direccion_vivienda d, telefonos f WHERE t.CURP_tutor = d.CURP_tutor AND t.CURP_tutor= f.CURP_tutor AND (t.Nombre='" + valor + "' OR t.Apellido_paterno='" + valor +"' or t.CURP_tutor = '" + valor + "');";
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (variable == 1) {
            ...
            try {
                String consult = "DELETE FROM telefonos WHERE CURP_tutor = \"" + cod + "\";";
                PS = CN.connectMySQL().prepareStatement(consult);
                PS.executeUpdate(consult);
                consult = "DELETE FROM direccion_vivienda WHERE CURP_tutor = \"" + cod + "\";";
                PS.executeUpdate(consult);
                consult = "DELETE FROM tutores WHERE CURP_tutor = \"" + cod + "\";";
                PS.executeUpdate(consult);
                mostrarDatos("");
            } catch (Exception e) {
                JOptionPane.showMessageDialog(null, "Error: " + e);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Editar_tutor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Editar_tutor dialog = new Editar_tutor(new javax.swing.JFrame(), true, false);
