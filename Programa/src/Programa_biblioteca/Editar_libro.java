...
public class Editar_libro extends javax.swing.JDialog {
    
    private PreparedStatement PS;
    private Conector CN;
    DefaultTableModel modelo = new DefaultTableModel();

    public Editar_libro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        panFondo_listas_alumnos.add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 30, -1, -1));
        ...
        panFondo_listas_alumnos.add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 30, 90, -1));
        ...
        panFondo_listas_alumnos.add(btnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1130, 30, 90, -1));
        ...
        panFondo_listas_alumnos.add(txtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 280, 30));
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (fila>=0) {
            Parametros.Titulo = tbDatos.getValueAt(fila, 0).toString();
            Parametros.RFID_alumno = tbDatos.getValueAt(fila, 8).toString();
            Parametros.Comp = true;
            new Agregar_libro(new javax.swing.JFrame(), true).setVisible(true);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (variable == 1) {
            ...
            try {
                ...
                PS = CN.connectMySQL().prepareStatement("DELETE FROM Libros WHERE Titulo = '" + tit + "' AND RFID = '" + rfid + "';");
                PS.executeUpdate();
                mostrarDatos(txtBuscar.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Editar_libro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Editar_libro dialog = new Editar_libro(new javax.swing.JFrame(), true);
