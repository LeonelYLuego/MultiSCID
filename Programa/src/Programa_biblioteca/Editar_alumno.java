...
public class Editar_alumno extends javax.swing.JDialog {
    ...
    public Editar_alumno(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        panFondo_listas_alumnos.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 1220, 370));
        ...
        panFondo_listas_alumnos.add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1140, 470, -1, -1));

        btnActualizar.setBackground(new java.awt.Color(13, 108, 140));
        ...
        panFondo_listas_alumnos.add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 50, 100, -1));
        ...
        panFondo_listas_alumnos.add(txtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 50, 280, 30));
        ...
        panFondo_listas_alumnos.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 50, -1, -1));
        ...
        panFondo_listas_alumnos.add(cmbGrupo, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, -1, 30));

        jLabel2.setBackground(new java.awt.Color(255, 255, 255));
        jLabel2.setFont(new java.awt.Font("Berlin Sans FB", 0, 14)); // NOI18N
        jLabel2.setText("Grupo:");
        panFondo_listas_alumnos.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 50, 20));

        jLabel1.setBackground(new java.awt.Color(255, 255, 255));
        jLabel1.setFont(new java.awt.Font("Berlin Sans FB", 0, 14)); // NOI18N
        jLabel1.setText("Nombre o apellido paterno:");
        panFondo_listas_alumnos.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 20, 190, 20));
        ...
        panFondo_listas_alumnos.add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 50, 100, -1));

        jButton2.setBackground(new java.awt.Color(13, 108, 140));
        ...
        panFondo_listas_alumnos.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1123, 50, 100, -1));

        getContentPane().add(panFondo_listas_alumnos, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1240, 510));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Editar_alumno dialog = new Editar_alumno(new javax.swing.JFrame(), true);
